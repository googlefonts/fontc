...
fn short_name(id: &AnyWorkId) -> &'static str {
    match id {
        ...
        AnyWorkId::Be(BeWorkIdentifier::PreliminaryFont) => "pre-font",
        AnyWorkId::Be(BeWorkIdentifier::FinalFont) => "font",
...
fn color(id: &AnyWorkId) -> &'static str {
    match id {
        ...
        AnyWorkId::Be(BeWorkIdentifier::PreliminaryFont) => "gray",
        AnyWorkId::Be(BeWorkIdentifier::FinalFont) => "gray",
