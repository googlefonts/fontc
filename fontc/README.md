...
This crate provides the command line entrypoint into our font compiler. It also intentionally exposes a programmatic library entrypoint (`pub fn generate_font`) for integrating `fontc` natively as a Rust library.
