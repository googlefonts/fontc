//! Generated by fontdrasil/data/update_glyphdata.py

use super::{Category, Script, Subcategory, bundled::BundledEntry};
...
impl BundledEntry for Option<Script> {
    ...
    fn from_slice(raw: &[u8]) -> Option<Script> {
        match raw[0] {
            ...
            58 => Some(Script::OldGeorgian),
            59 => Some(Script::Oriya),
            60 => Some(Script::Osage),
            61 => Some(Script::Osmanya),
            62 => Some(Script::PahawhHmong),
            63 => Some(Script::PhaistosDisc),
            64 => Some(Script::Rovas),
            65 => Some(Script::Runic),
            66 => Some(Script::Samaritan),
            67 => Some(Script::Shavian),
            68 => Some(Script::Sinhala),
            69 => Some(Script::Syriac),
            70 => Some(Script::Tagalog),
            71 => Some(Script::Tamil),
            72 => Some(Script::Telugu),
            73 => Some(Script::Thaana),
            74 => Some(Script::Thai),
            75 => Some(Script::Tham),
            76 => Some(Script::Tibet),
            77 => Some(Script::Tifinagh),
            78 => Some(Script::TuluTigalari),
            79 => Some(Script::Vai),
            80 => Some(Script::Yezidi),
            81 => Some(Script::Yi),
            255 => None,
            v => panic!("What is {v}"),
        }
