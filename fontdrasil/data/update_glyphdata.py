...
Usage:
    python fontdrasil/data/update_glyphdata.py
"""
...
def main():
    ...
    enums_file = Path(__file__).parent.parent / "src" / "glyphdata" / "bundled_impls.rs"
    ...
    with open(enums_file, "w") as f:
        f.write("//! Generated by fontdrasil/data/update_glyphdata.py\n")
        f.write("\n")

        f.write("use super::{Category, Script, Subcategory, bundled::BundledEntry};")
        f.write("\n")
